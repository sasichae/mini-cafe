  ...
  return (
    <div className="min-h-full flex flex-col bg-cream">
      <div className="flex-1 flex min-h-0">
        <nav className="flex-shrink-0 flex flex-col w-[220px] bg-espresso" aria-label="Admin">
          ...
          <ul className="flex-1 space-y-1 px-3 list-none m-0 p-0">
            <li>
              <button
                type="button"
                className={`flex items-center gap-3 w-full rounded-md px-3 py-2.5 border-none text-sm text-left cursor-pointer transition-colors ${tab === 'dashboard' ? 'bg-espresso-soft text-cream font-medium' : 'bg-transparent text-cream/75 hover:bg-espresso-soft/50 hover:text-cream'}`}
            ...
            <li>
              <button
                type="button"
                className={`flex items-center gap-3 w-full rounded-md px-3 py-2.5 border-none text-sm text-left cursor-pointer transition-colors ${tab === 'orders' ? 'bg-espresso-soft text-cream font-medium' : 'bg-transparent text-cream/75 hover:bg-espresso-soft/50 hover:text-cream'}`}
            ...
            <li>
              <button
                type="button"
                className={`flex items-center gap-3 w-full rounded-md px-3 py-2.5 border-none text-sm text-left cursor-pointer transition-colors ${tab === 'products' ? 'bg-espresso-soft text-cream font-medium' : 'bg-transparent text-cream/75 hover:bg-espresso-soft/50 hover:text-cream'}`}
